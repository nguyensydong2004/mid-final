    ...
    <div class="row justify-content-center d-flex mt-5">
        <div class="col-md-12">
            <a href="{{route('home')}}" class="text-decoration-none text-dark ">
                <i class="fa fa-arrow-left" aria-hidden="true"></i> &nbsp; <strong>Quay lại danh sách sách</strong>
            </a>
            <div class="row mt-4">
                <div class="col-md-4">
                    @if ($book->image != '') 
                ...
                <div class="col-md-8">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <h2 class="h3 mb-4">Người đọc cũng quan tâm</h2>
                        </div>
                                ...
                                <div class="card border-0 shadow-lg">
                                    <a href="{{route("book.detail",$relatedBook->id)}}">
                                        @if ($relatedBook->image != '') 
                                            <img src="{{asset('uploads/books/cover/'.$relatedBook->image)}}" alt="" class="card-img-top">
                                        @else
                                            <img src="https://placehold.co/990x1400?text=No Image" alt="" class="card-img-top">
                                        @endif
                                    </a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="star-rating d-inline-flex ml-2" title="">
                                            ...
                                            <span class="theme-font text-muted">({{($relatedBook->reviews_count > 1)? $relatedBook->reviews_count.' Đánh giá':$relatedBook->reviews_count.' Đánh giá'}})</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12  mt-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    ...
                                    @else
                                    <a href="{{route('account.login')}}" class="btn btn-primary">Thêm đánh giá</a>
                                    @endif 
                                </div>
                            </div>                        
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">Thêm đánh giá cho <strong>{{$book->title}}</strong></h1>
